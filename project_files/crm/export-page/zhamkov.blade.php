                        ...
                        <div class="clients-contracts-data">
                            ...
                            <div class="field-container">
                                ...
                                <div class="input-block" style="margin-right:0px;">
                                    <label>&nbsp;</label>
                                    <a href="/manager/export-page/clients-count?period={{date('Y-m')}}" class="submit execute-export5">@lang('message.export')</a>
                                </div>
                            </div>
                            <div class="field-container">
                                <div class="input-block w260">
...
<script>
    $(document).ready(function(){
        ...
        $('[name="period3"], [name="period4"]').change(function(){
            $('.execute-export5').attr('href', '/manager/export-page/clients-count?ym='+$('[name="period3"]').val()+'/'+$('[name="period4"]').val());
        })
        $('.execute-export3, .execute-export5, .execute-export9_, .execute-export9__, .execute-export10, .execute-export12, .execute-export-by-firms-and-cities').click(function(){
            let this_ = this;
