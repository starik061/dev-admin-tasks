          ...
          <div class="client-tab-data-block">
            <div class="client-contacts-header mb20">
              <div class="left-block">
                ...
                <form action="/manager/suppliers/{{$supplier->id}}/companies" method="GET" class="input-block search-form">
                  <label for="company_search">Поиск</label>
              ...
              <div class="right-block">
                <a href="/manager/suppliers/{{ $supplier->id }}/companies/add" class="btn submit">@lang('message.add_company')</a>
              </div>
            </div>
            {{--<hr class="mtb20"/>--}}
            @if(count($companies))
              ...
              <div class="data-table">
                ...
                <div class="data-tbody">
                  ...
                  <div class="data-tr" id="company_tr_{{$company->id}}">
                    ...
                    <div class="data-td">{{ $company->type_id == '1' ? __('message.VAT') : __('message.notVAT') }}</div>
                    <div class="data-td action-col align-right">
                      ...
                      <div class="sub-action hide">
                        <a href="/manager/suppliers/{{$supplier->id}}/companies/{{$company->id}}/view">@lang('message.view')</a>
                        <a href="/manager/suppliers/{{$supplier->id}}/companies/{{$company->id}}/edit">@lang('message.edit')</a>
                        <a href="/manager/suppliers/{{$supplier->id}}/companies/{{$company->id}}/signers">@lang('message.signers')</a>
                        @if($company->can_delete && in_array(Auth::user()->id,[1,202,248]))
                        <a href="/manager/suppliers/{{$supplier->id}}/companies/delete" class="company-delete" data-id="{{$company->id}}">@lang('message.delete')</a>
                        @endif
