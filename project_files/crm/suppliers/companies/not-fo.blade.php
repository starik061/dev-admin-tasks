<div class="company-info">
  ...
  <div class="block">
	...
	<div class="line">
	  <div class="title">@lang('message.card_number')</div>
	  <div class="value">{{$company->card_number}}</div>
	</div>
	<div class="line">
	  <div class="title">@lang('message.card_bank')</div>
	  <div class="value">{{$company->card_bank}}</div>
	</div>
	<div class="line">
	  <div class="title">@lang('message.recipient_')</div>
	  <div class="value">{{$company->card_recipient}}</div>
	</div>
  </div>
  <hr/>
  <div class="block">
