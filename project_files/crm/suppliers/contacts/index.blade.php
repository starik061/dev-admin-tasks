          ...
          <div class="client-tab-data-block">
            ...
            <div class="clients-contacts-data">
              <div class="data-table">
                ...
                @include('front.crm.suppliers.contacts.rows')
                </div>
              </div>
            </div>
          </div>
...
<div class="contacts-add-popup">
  ...
  <div class="contacts-add-form">
    <form method="POST" action="/manager/suppliers/{{ $supplier->id }}/contacts/add">
...
let add_action = '/manager/suppliers/{{ $client->id }}/contacts/add';
</script>
