              ...
              <div class="data-table">
                ...
                <form method="POST" action="{{route('settings.index')}}">
                  ...
                  <div class="data-tbody contracts-rows">
                    <div class="data-tr">
                      <div class="data-td td-name">@lang('message.manager_emails')</div>
                      <div class="data-td action-col field-container">
                        <div class="input-block" style="margin:0">
                          <input type="text" name="manager_email" value="{{$manager_email->value}}" class="setting-input"/>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="data-tbody contracts-rows">
                    <div class="data-tr">
                      <div class="data-td td-name">@lang('message.markup')</div>
                      <div class="data-td action-col field-container">
                        <div class="input-block" style="margin:0">
                          <input type="text" name="markup" value="{{$markup->value}}" class="setting-input"/>
                        </div>
                      </div>
                    </div>
                  </div>
