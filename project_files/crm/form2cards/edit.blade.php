                            ...
                            <div class="input-block">
                                ...
                                <select name="details_id" class="details" required>
                                    @foreach($details as $item)
                                        <option value="{{$item->id}}" @if($item->id == $card->details_id) selected @endif>{{$item->name_short}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="input-block">
                                <label>Назва картки</label>
                                <input type="text" name="card_name" value="{{$item->card_name}}" />
                            </div>
                        </div>
                        {{--
                        <div class="field-container">
                            <div class="input-block">
                                <label>IBAN</label>
                                <input type="text" name="iban" value="{{$card->iban}}" />
                            </div>
                            <div class="input-block">
