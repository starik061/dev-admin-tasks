...
<section class="lead-block">
    <div class="container-fluid container-fluid-base">
        <div class="row no-gutters navigation-wrapper">
            <div class="container container-base mw1280 pl20 pr20">
                ...
                <div class="client-tab-data-block pt0">
                    <div class="content-block clearfix">
                        @if(count($reports) || count($params))
                            <div class="photoreport-filter-block mw1460" style="margin: 0 auto">
                                <div class="photoreport-filter-action-block">
                                    <div class="header-styles">
                                        ...
                                        <div class="photoreports-search-button input-block filter-btn-block">
                                            <span class="search-button pointer crm-button" style="margin-top: 0;">
                                            ...
                                            <div class="bk-filter-fields">
                                                @if($clients)
                                                    <div class="field-container">
                                                        <div class="input-block big-input-block">
                                                            ...
                                                            <select name="client_id" class="manager-select"
                                                                    id="report-client"
                                                                    style="width: 100%">
                                                ...
                                                <div class="field-container">
                                                    <div class="input-block big-input-block">
                                                        ...
                                                        <select name="report-type" class="manager-select"
                                                                id="report-type"
                                                                style="width: 100%">
                                                            <option value="all">@lang('message.all')</option>
                                                            @if($filterTypes)
                                                ...
                                                @if(!isset($client_view) || !$client_view)
                                                    <div class="field-container">
                                                        <div class="input-block big-input-block">
                                                            ...
                                                            <select name="report-user" class="manager-select"
                                                                    id="report-user"
                                                                    style="width: 100%">
                                                                <option value="all">@lang('message.all')</option>
                                                                @if($users)
                                ...
                                @if(@count($reports))
                                    <div class="photoreports-thead">
                                        <div class="photoreports-row">
                                            ...
                                            @if(!isset($client_view) || !$client_view)
                                                <div class="photoreports-col">@lang('message.client')</div>
                                                <div class="photoreports-col">@lang('message.manager')</div>
                                            @endif
                                            <div class="photoreports-col">@lang('message.city')</div>
                                            <div class="photoreports-col">@lang('message.address')</div>
                                            <div class="photoreports-col">@lang('message.contract')</div>
                                            <div class="photoreports-col">@lang('message.application')</div>
                                            <div class="photoreports-col">@lang('message.firm')</div>
                                            <div class="photoreports-col">@lang('message.plane_code2')</div>
                                            <div class="photoreports-col">@lang('message.contractor_code')</div>
                                            <div class="photoreports-col">@lang('message.rental_period')</div>
                                            <div class="photoreports-col">@lang('message.month2')</div>
                                            <div class="photoreports-col">@lang('message.layout')</div>
                                            <div class="photoreports-col">@lang('message.work_type')</div>
                                            <div class="photoreports-col">@lang('message.near')</div>
                                            <div class="photoreports-col">@lang('message.far')</div>
                                            <div class="photoreports-col">@lang('message.night')</div>
                                            <div class="photoreports-col action-col"></div>
                                        </div>
                                    </div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        document.querySelectorAll('.photoreports-col').forEach(el => {
            const fullText = el.textContent.trim();
            if (fullText.length > 100) {
                const shortText = fullText.substring(0, 100) + '...';
                el.textContent = shortText;
                el.dataset.fullText = fullText;
                el.dataset.shortText = shortText;
