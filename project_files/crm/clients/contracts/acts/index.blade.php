...
$canEdit = !count($act->not_from_root_addition_agreement);
@endphp
<div class="popup-data">
  <div class="act-popup-title">
    <h2>
        @if(!$act->number)
            @lang('message.bill_without_contract')
        @else
            @if($act->parent_id)
  ...
  <div class="act-popup-menu-block">
    ...
    @if(($act->can_delete || in_array(Auth::user()->id,[1,202,248,263])) && $canEdit)
    ...
    <!-- тут был endif -->
      ...
      <a class="application-actions">
        ...
        <ul class="application-sub-action hide">
          ...
          <li><span class="act-generate-update-with-bills @if(!$act->boards) hide @endif" data-client_id="{{$client->id}}" data-contract_id="{{$contract->id}}" data-act_id="{{$act->id}}">@lang('message.generate_app_and_regenerate_bills')</span></li>
          @endif
          --}}
          {{--
  ...
  @if($act->can_delete || in_array(Auth::user()->id, [202,248]))
...
{{--      <a class="new-flex-link" id="custom-watchAll" data-type="client" data-client_id="{{$client->id}}">--}}
{{--          <svg width="25" height="30" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">--}}
{{--              <path fill-rule="evenodd" clip-rule="evenodd" d="M10 4.16667C6.42487 4.16667 3.33333 7.25821 3.33333 10C3.33333 12.7418 6.42487 15.8333 10 15.8333C13.5751 15.8333 16.6667 12.7418 16.6667 10C16.6667 7.25821 13.5751 4.16667 10 4.16667ZM10 14.1667C8.29516 14.1667 6.83333 12.7048 6.83333 10C6.83333 7.29516 8.29516 5.83333 10 5.83333C11.7048 5.83333 13.1667 7.29516 13.1667 10C13.1667 12.7048 11.7048 14.1667 10 14.1667ZM10 7.5C8.80657 7.5 7.83333 8.47321 7.83333 9.66667C7.83333 10.8601 8.80657 11.8333 10 11.8333C11.1934 11.8333 12.1667 10.8601 12.1667 9.66667C12.1667 8.47321 11.1934 7.5 10 7.5ZM10 9.16667C10.918 9.16667 11.6667 9.91533 11.6667 10.8333C11.6667 11.7513 10.918 12.5 10 12.5C9.08203 12.5 8.33333 11.7513 8.33333 10.8333C8.33333 9.91533 9.08203 9.16667 10 9.16667Z" fill="#FC6B40"/>--}}
{{--          </svg>--}}
{{--          @lang('message.watch')--}}
{{--      </a>--}}

{{--      <a class="new-flex-link" id="custom-watch-remove" data-type="client" data-registered="{{ Auth::user() ? 'true' : 'false' }}" data-selection_id="{{$selection->id}}" data-client_id="{{$client->id}}">--}}
{{--          <svg width="25" height="30" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">--}}
{{--              <path fill-rule="evenodd" clip-rule="evenodd" d="M10 4.16667C6.42487 4.16667 3.33333 7.25821 3.33333 10C3.33333 12.7418 6.42487 15.8333 10 15.8333C13.5751 15.8333 16.6667 12.7418 16.6667 10C16.6667 7.25821 13.5751 4.16667 10 4.16667ZM10 14.1667C8.29516 14.1667 6.83333 12.7048 6.83333 10C6.83333 7.29516 8.29516 5.83333 10 5.83333C11.7048 5.83333 13.1667 7.29516 13.1667 10C13.1667 12.7048 11.7048 14.1667 10 14.1667ZM10 7.5C8.80657 7.5 7.83333 8.47321 7.83333 9.66667C7.83333 10.8601 8.80657 11.8333 10 11.8333C11.1934 11.8333 12.1667 10.8601 12.1667 9.66667C12.1667 8.47321 11.1934 7.5 10 7.5ZM10 9.16667C10.918 9.16667 11.6667 9.91533 11.6667 10.8333C11.6667 11.7513 10.918 12.5 10 12.5C9.08203 12.5 8.33333 11.7513 8.33333 10.8333C8.33333 9.91533 9.08203 9.16667 10 9.16667Z" fill="#FC6B40"/>--}}
{{--              <path d="M3.5 3.5L16.5 16.5" stroke="#FC6B40" stroke-width="2" stroke-linecap="round"/>--}}
{{--          </svg>--}}
{{--        @lang('message.remove_tracking')--}}
{{--      </a>--}}
  	  ...
  	  <form id="services-form" data-contract_id="{{$contract->id}}" data-client_id="{{$client->id}}" data-act_id="{{$act->id}}">
            ...
            <div class="services-supplier">
                <div class="supplier-type-item">
                    <input type="checkbox" name="by_supplier[0]" value="1"> @lang('message.many_suppliers')
                </div>
                <div class="supplier-service-block">
                    <select name="supplier_id[0]" class="services-supplier-dd">
