<div class="popup-form zi10102">
    ...
    <div class="popup-form-body">
        <form method="POST" action="/manager/supplier/services-payment/{{$payment->id}}/change" id="supplier-service-payment-form" data-id="{{$payment->id}}">
            ...
            <div class="field-container">
                <div class="input-block">
                    ...
                    <input type="text" value="{{$payment->sum}}" name="sum" />
                </div>
            </div>
            <div class="field-container">
                <div class="input-block">
