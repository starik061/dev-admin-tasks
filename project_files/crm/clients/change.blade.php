<div class="change-popup zi10101">
	<div class="change-popup-header">
		<span>@lang('message.change_manager')</span>
		<span class="close">
	...
	<div class="change-popup-body">
		<form method="POST" action="/manager/clients/{{$client->id}}/change-manager" >
			<input type="hidden" name="id" value="{{$client->id}}"/>
			<div class="field-container">
				<div class="input-block">
					<label>@lang('message.manager')</label>
					<select class="change-manager" name="user_id">
