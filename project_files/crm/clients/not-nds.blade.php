        ...
        <div  class="container container-base container-search-result manager-search client-details-container">
          ...
          <div class="content-block content-details">
            <div class="details-tabs-content">
              <div class="tab-block">
                <form method="POST" id="form-not-nds" action="{{$action}}" class="form-details">
                  ...
                  <div class="input-group">
                    <div class="input-block">
                      ...
                      <input type="text" name="edrpou" value="{{ $details->edrpou }}" required  class="l10" minlength="6" maxlength="10" autocomplete="off" />
                      <a class="get-edrpou @if(!$details->edrpou) hide @endif">Получить данные по ДРФО/ЕДРПОУ</a>
                    </div>
                  ...
                  <div class="input-group">
                    <div class="input-block">
                      ...
                      <input type="text" name="fio" value="{{ $details->fio }}" required />
                    </div>
                    <div class="input-block ib-break">
                    ...
                    <div class="input-block mr15">
                      ...
                      <input type="text" name="fio_r" value="{{ $details->fio_r }}" required />
                    </div>
                    <div class="input-block ib-break">
                  ...
                  <div class="input-group">
                    <div class="input-block">
                      ...
                      <input type="text" name="based_on" value="{{ $details->based_on ? $details->based_on : 'Статуту' }}" class="full_name" required />
                    </div>
                  </div>
