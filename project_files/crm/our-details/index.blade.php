  ...
  <div class="container-fluid container-fluid-base">
    <div class="row no-gutters">
      <div class="container container-base container-search-result manager-search our-details details-block">
        ...
        <a class="crm-button abs-top-right" href="/manager/details/new">@lang('message.add_our_details')</a>
                ...
                <div class="data-tr-global">
                  <div class="data-tr" data-id="{{$item->id}}">
                    ...
                    <div class="data-td action-col">
                      <a href="/manager/details/{{$item->id}}/edit" class="edit mr0">
                  ...
                  <div class="details-data hide">
                    <div class="info-block-table">
                      <div class="tr">
                        <div class="td">
                          <span>@lang('message.address'):</span>
                        </div>
                        <div class="td">
                          {{ $item->address }}
                        </div>
                      ...
                      <div class="tr">
                        <div class="td">
                          <span>@lang('message.tax_status'):</span>
                        </div>
                        <div class="td">
                          {{ $item->status_tax }}
                        </div>
