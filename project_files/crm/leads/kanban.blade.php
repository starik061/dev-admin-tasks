            ...
            <div class="container container-base container-search-result manager-search mw1460">
                <h1 class="title-search-result" style="position: relative">
                    ...
                    <div class="leads-view-type">
                        <div class="line-view view-item" data-url="/manager/leads">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path d="M6.66797 5H17.5013" stroke="#3D445C" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M6.66797 10H17.5013" stroke="#3D445C" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M6.66797 15H17.5013" stroke="#3D445C" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M2.5 5H2.50833" stroke="#3D445C" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M2.5 10H2.50833" stroke="#3D445C" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M2.5 15H2.50833" stroke="#3D445C" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                            </svg>
                        </div>
                        <div class="box-view view-item active" data-url="/manager/leads?tmplt=kanban">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path d="M15.8333 2.5H4.16667C3.24619 2.5 2.5 3.24619 2.5 4.16667V15.8333C2.5 16.7538 3.24619 17.5 4.16667 17.5H15.8333C16.7538 17.5 17.5 16.7538 17.5 15.8333V4.16667C17.5 3.24619 16.7538 2.5 15.8333 2.5Z"
                                      stroke="#3D445C" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M2.5 10H17.5" stroke="#3D445C" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M10 2.5V17.5" stroke="#3D445C" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                            </svg>
                        </div>
                    </div>
                        ...
                        <div class="header-block">
                            <div class="search-block">
                                <form action="/manager/leads" method="GET" class="search-form field-container">
                                    <input type="hidden" name="tmplt" value="kanban"/>
                                            ...
                                            <select name="user_id">
                                                ...
                                                @foreach($users as $user)
                                                    <option value="{{$user->id}}"
                                                            @if(@$params['user_id'] == $user->id) selected @endif>{{$user->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    @endif
                                        ...
                                        <select name="city_id">
                                            ...
                                            @foreach($cities as $city)
                                                <option value="{{$city->id}}"
                                                        @if(@$params['city_id'] == $city->id) selected @endif>{{$city->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="input-block w260">
                                        ...
                                        <select name="status_id">
                                            ...
                                            @foreach($statuses as $status)
                                                <option value="{{$status->id}}"
                                                        @if(@$params['status_id'] == $status->id) selected @endif>{{$status->getTranslatedAttribute('name', 'ua', 'ru')}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="input-block w260">
                                    ...
                                    <div class="input-block small-input-block">
                                        ...
                                        <svg class="clear-search @if(!@$created_at) hide @endif" width="13" height="13"
                                             viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M0.493543 11.3126L0.387477 11.4187L0.493543 11.5248L1.12994 12.1612L1.23601 12.2672L1.34207 12.1612L6.32717 7.17607L11.3123 12.1612L11.4183 12.2672L11.5244 12.1612L12.1608 11.5248L12.2669 11.4187L12.1608 11.3126L7.1757 6.32754L12.1608 1.34244L12.2669 1.23637L12.1608 1.13031L11.5244 0.49391L11.4183 0.387844L11.3123 0.49391L6.32717 5.47901L1.34207 0.49391L1.23601 0.387844L1.12994 0.49391L0.493543 1.13031L0.387477 1.23637L0.493543 1.34244L5.47865 6.32754L0.493543 11.3126Z"
                                                  fill="#3D445C" stroke="#3D445C" stroke-width="0.3"/>
                                        </svg>
                                    ...
                                    <div class="form-group mr-2 input-block">
                                        ...
                                        <select name="date_range" id="date_range" class="form-control"
                                                style="width: 220px;">
                                            <option value="" disabled @if(!isset($params['date_range'])) selected
                                                    @endif hidden>Выберите период
                                            </option>
                                            <option value="today"
                                                    @if(isset($params['date_range']) && $params['date_range'] == 'today') selected @endif>
                                                Сегодня
                                            </option>
                                            <option value="yesterday"
                                                    @if(isset($params['date_range']) && $params['date_range'] == 'yesterday') selected @endif>
                                                Вчера
                                            </option>
                                            <option value="current_week"
                                                    @if(isset($params['date_range']) && $params['date_range'] == 'current_week') selected @endif>
                                                Текущая неделя
                                            </option>
                                            <option value="last_week"
                                                    @if(isset($params['date_range']) && $params['date_range'] == 'last_week') selected @endif>
                                                Прошлая неделя
                                            </option>
                                            <option value="current_month"
                                                    @if(isset($params['date_range']) && $params['date_range'] == 'current_month') selected @endif>
                                                Текущий месяц
                                            </option>
                                            <option value="last_month"
                                                    @if(isset($params['date_range']) && $params['date_range'] == 'last_month') selected @endif>
                                                Прошлый месяц
                                            </option>
                                            <option value="all_time"
                                                    @if(isset($params['date_range']) && $params['date_range'] == 'all_time') selected @endif>
                                                Всё время
                                            </option>
                                            <option value="custom"
                                                    @if(isset($params['date_range']) && $params['date_range'] == 'custom') selected @endif>
                                                Пользовательский диапазон
                                            </option>
                                        </select>
                                    </div>

                                    <input type="hidden" name="created_at" value="{{@$created_at}}" id="dt_search"/>


                                    {{--                                    <div class="input-block small-input-block">--}}
                                    {{--                                        <label for="dt_search">Дата создания</label>--}}
                            ...
                            <div class="right-block">
                                <div class="show-block">
                                    <div class="switcher-block">
                                        ...
                                        <div class="switcher">
                                            <input type='checkbox' class='ios8-switch' id='show-with-selection'
                                                   @if($with_selection == "true") checked @endif>
                                    ...
                                    <div class="switcher-block"
                                        ...
                                        <div class="switcher">
                                            <input type='checkbox' class='ios8-switch' id='show-hidden'
                                                   @if($show_hidden == "true") checked @endif>
                                            <label for='show-hidden'>&nbsp;</label>
                                        </div>
                                    </div>
                                    <div class="switcher-block">
                                        <div class="switcher-label">@lang('message.detailed_information')</div>
                                        <div class="switcher">
                                            <input type='checkbox' class='ios8-switch' id='full_data'
                                                   @if($full_data == "true") checked @endif>
                                            <label for='full_data'>&nbsp;</label>
                                        </div>
                                    </div>
                                    <div class="switcher-block">
                                        <div class="switcher-label">@lang('message.from_old_to_new')</div>
                                        <div class="switcher">
                                            <input type='checkbox' class='ios8-switch' id='oldest'
                                                   @if($oldest == "true") checked @endif>
                            ...
                            @php
                                ...
                                $width = 3660;
                                    ...
                                    foreach($statuses as $item){
                                        if($_COOKIE['kanban_'.$item->id.'_opened'] == '0'){
                                            $width = $width  - 342 + 78;
                                        }
                                    }
                            @endphp
                            <div class="kanban-body" style="width: {{$width}}px">
                                @if(@count($leads))
                                    @php
                                        $kanban = $leads;
                                        $kanban = $kanban->groupBy('status_id');
                                        $status7count = 0;
                                        $status11count = 0;
                                    @endphp
                                    @foreach($statuses as $item)
                                        <div class="kanban-item clearfix {{$_COOKIE['kanban_'.$item->id.'_opened'] == '0' ? 'item-collapse' : ''}}"
                                             id="kanban_col-{{$item->id}}">
                                            <div class="kanban-item-header">
                                                <div class="opener {{$_COOKIE['kanban_'.$item->id.'_opened'] == '0' ? 'closed' : ''}}"
                                                    ...
                                                    <svg width="30" height="30" viewBox="0 0 30 30" fill="none"
                                                        ...
                                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                                              d="M14.4804 11.7314C14.7668 11.445 15.2311 11.445 15.5175 11.7314L21.0175 17.2314C21.3039 17.5178 21.3039 17.9821 21.0175 18.2685C20.7311 18.5549 20.2668 18.5549 19.9804 18.2685L14.999 13.287L10.0175 18.2685C9.73112 18.5549 9.2668 18.5549 8.98041 18.2685C8.69403 17.9821 8.69403 17.5178 8.98041 17.2314L14.4804 11.7314Z"
                                                              fill="#3D445C"/>
                                                    </svg>
                                                </div>
                                                <div class="item-name">
                                                    ...
                                                    @if($kanban[$item->id])
                                                        <span class="count">
                                                        {{ count($kanban[$item->id]) }}
                                                    </span>
                                                    @endif
                                                </div>
                                                <div class="item-add">
                                                    <a href="/manager/leads/add" class="new-btn2"
                                                       data-status_id="{{$item->id}}">
                                                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none"
                                                             xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="kanban-item-leads kanban-sortable"
                                                 {!! $_COOKIE['kanban_'.$item->id.'_opened'] == '0' ? 'style="display:none;"' : '' !!} id="status-block-{{$item->id}}"
                                                 data-status_id="{{$item->id}}">
                                                @if($kanban[$item->id])
                                                    @foreach($kanban[$item->id] as $lead)
                                                        <div class="lead-item" id="lead-{{$lead->id}}"
                                                             @if($lead->visible==0) style="background:#ccc"
                                                             @endif data-avaliable_statuses="{{$item->avaliable_statuses}}"
                                                             data-status_id="{{$lead->status_id}}"
                                                             data-class_id="{{$lead->class_id}}"
                                                             data-selections="{{$lead->selections}}">
                                                            <div class="lead-title">
                                                                <div class="lead-opener {{$_COOKIE['lead_'.$lead->id.'_opened'] == '0' ? 'closed' : ''}}"
                                                                     data-lead_id="{{$lead->id}}">
                                                                    <svg width="22" height="22" viewBox="0 0 22 22"
                                                                         fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                                                              d="M10.4804 7.73139C10.7668 7.44501 11.2311 7.44501 11.5175 7.73139L17.0175 13.2314C17.3039 13.5178 17.3039 13.9821 17.0175 14.2685C16.7311 14.5549 16.2668 14.5549 15.9804 14.2685L10.999 9.28702L6.0175 14.2685C5.73112 14.5549 5.2668 14.5549 4.98041 14.2685C4.69403 13.9821 4.69403 13.5178 4.98041 13.2314L10.4804 7.73139Z"
                                                                              fill="#3D445C"/>
                                                                    </svg>
                                                                </div>
                                                                <div class="lead-name">
                                                                <span class="lead-favorite" data-id="{{$lead->id}}">
                                                                @if($lead->favorite)
                                                                        <svg class="favorite" width="18" height="18"
                                                                             viewBox="0 0 18 18" fill="none"
                                                                             xmlns="http://www.w3.org/2000/svg">
                                                                        <path d="M9 1.5L10.7705 6.94907H16.5L11.8648 10.3168L13.6352 15.7658L9 12.3982L4.36475 15.7658L6.13525 10.3168L1.5 6.94907H7.22949L9 1.5Z"
                                                                              fill="#FC6B40" stroke="#FC6B40"
                                                                    ...
                                                                    @else
                                                                        <svg width="18" height="18" viewBox="0 0 18 18"
                                                                             ...
                                                                             xmlns="http://www.w3.org/2000/svg">
                                                                        <path d="M9 1.5L10.7705 6.94907H16.5L11.8648 10.3168L13.6352 15.7658L9 12.3982L4.36475 15.7658L6.13525 10.3168L1.5 6.94907H7.22949L9 1.5Z"
                                                                              stroke="#CDD4D9" stroke-width="1.125"
                                                                    ...
                                                                    <a href="{{ route('leads.view', ['id' => $lead->id]) }}"
                                                                       class="view-lead" data-id="{{$lead->id}}">
                                                                        {{$lead->name}}@if($lead->fio)
                                                                            , {{$lead->fio}}
                                                                        @endif
                                                                    </a>
                                                                </div>
                                                            ...
                                                            <div class="lead-action-menu-items">
                                                                <div class="item">
                                                                    <a href="/manager/leads/{{$lead->id}}/info"
                                                                       data-id="{{$lead->id}}">@lang('message.view')</a>
                                                                </div>
                                                                <div class="item">
                                                                    <a href="{{ route('leads.edit', ['id' => $lead->id]) }}">@lang('message.edit')</a>
                                                                </div>
                                                                <div class="item">
                                                                    <a href="{{ route('leads.change-status', ['id' => $lead->id]) }}"
                                                                       class="change-lead-status-link">@lang('message.change_status')</a>
                                                                </div>
                                                                @if(Auth::user()->role_id == 1)
                                                                    <div class="item">
                                                                        <a class="del_"
                                                                           data-id="{{$lead->id}}">@lang('message.delete')</a>
                                                                    </div>
                                                                @endif
                                                            </div>
                                                            <div class="lead-data">
                                                                @if($lead->phone)
                                                                    <span class="lead-info-phone" style="cursor: pointer">
                                                                    {{$lead->phone}}
                                                                        @if(count($lead->contacts) > 1)
                                                                            @foreach($lead->contacts as $index => $contact)
                                                                ...
                                                                @endif
                                                                @if($lead->email)
                                                                    <span class="lead-info-email" style="cursor: pointer">
                                                                    {{$lead->email}}
                                                                        @if(count($lead->contacts) > 1)
                                                                            @foreach($lead->contacts as $index => $contact)
                                                                ...
                                                                @endif
                                                                <div class="short-hide" {!! $_COOKIE['lead_'.$lead->id.'_opened'] == '0' ? 'style="display:none;"' : '' !!}>
                                                                    @if($lead->cities)
                                                                        <span class="lead-info-city">{{$lead->cities}}</span>
                                                                    @endif

                                                                    <span class="lead-info-created_at">{{ date('d.m.Y H:i:s', strtotime($lead->created_at)) }}
                                                                <span style="background: {{ $lead->class->background }}; display: inline; padding: 5px 5px; border-radius: 3px; font-size: 12px;">
                                                                {{$lead->class->name}}
                                                              </span>
                                                            </span>

                                                                    @if($lead->source)
                                                                        <span class="lead-info-source">{{$lead->source.", ".$lead->utm_channel}}</span>
                                                                    @endif
                                                                    @if(Auth::user()->role_id == 1)
                                                                        <span class="lead-info-manager">{{$lead->user->name}}</span>
                                                                    @endif
                                                                </div>
                                                        ...
                                                        @php
                                                            ...
                                                            if($lead->status->id == 11){
                                                                $status11count++;
                                                            }
                                                            if($status7count == 20 && $lead->status->id == 7){
                                                                break;
                                                            }
                                                            if($status11count == 20 && $lead->status->id == 11){
                                                                break;
                                                            }
                                                        @endphp
                                                    @endforeach
                                ...
                                @else
                                    <div class="no-data" @if($search) style="width:100%" @endif>
                                        ...
                                        <span class="no-data-title">@lang('message.no_result')</span>
                                    </div>
                                @endif
                            </div>
                        </div>
...
@if(session('accept'))
    <div class="success-mesage">
        @lang('message.you_accepted_an_order_from_a_lead') <b>{{ session('name') }}</b>!
        <div class="notify-close">×</div>
    </div>
@endif
@if(session('allready-accepted'))
    <div class="success-mesage">
        @lang('message.order_from')
        <b>{{ session('name') }}</b> @lang('message.already_took') {{ session('user_name') }}!
        <div class="notify-close">×</div>
    </div>
@endif
...
<div class="lead-add-popup zi10101-">
    ...
    <div class="lead-add-form">
        <form method="POST" action="{{ route('leads.store') }}?tmplt=kanban">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.querySelectorAll('textarea[name="comment"]').forEach(initTextarea);

        // Обработка отправки форм с делегированием
        document.addEventListener('submit', function (e) {
            if (e.target.matches('.comment-update-form')) {
                e.preventDefault();
        ...
        // Если textarea появляется динамически, например через AJAX, вызывай этот метод после добавления:
        window.initDynamicCommentField = function(textarea) {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.querySelectorAll('.lead-info-phone, .lead-info-email').forEach(span => {
...
<style>
    ...
    .default-popup.lead-status-popup {
        width: 600px;
    }
    ...
    .mw1460 .field-container .input-block select[name=class_id],
...
@if(session('success') || @$success || session('accept') || session('allready-accepted'))
    <script>
        ...
        if (window.location.href.indexOf("created")) {
            window.history.pushState({}, $('title').text(), main_url + "/?tmplt=kanban");
        }
        setTimeout(function () {
...
<script type="text/javascript">
    const observer = new MutationObserver(function(mutations) {
        mutations.forEach(function(mutation) {
            mutation.removedNodes.forEach(function(removedNode) {
                if ($(removedNode).hasClass('lead-status-popup')) {
                    // Логика после закрытия попапа
                    $('.al-overlay3').addClass('hide');
                    $('.ui-draggable-handle').css('left', '').css('top', '').css('position','');
                }
            });
        });
    });
    ...
    @endif
        ...
        document.changeManagerView = false;
    ...
    const LeadChangeVisible = (leadId, visible) => {
        $.post('/manager/leads/' + leadId + '/change-visible', {'visible': visible}, function () {
            if (visible) {
                ...
                $('#lead-' + leadId).css('background', '#fff')
            } else {
                $('#v-' + leadId).data('visibility', 0).empty().append(ShowVisibility);
                $('#lead-' + leadId).css('background', '#ccc')
            }
        })
    }
    @php
        $lead = null;
    @endphp
    const defaultStatusForm = `@include('front/crm/leads/status-default-form')`;
    const pauseStatusForm = `@include('front/crm/leads/status-pause-form')`;
    const invalidStatusForm = `@include('front/crm/leads/status-invalid-form')`;
    const rejectStatusForm = `@include('front/crm/leads/status-reject-form')`;
    const qualificationPassedForm = `@include('front/crm/leads/status-qualification-passed-form')`;

    blockPositions = {
        @foreach ($statuses as $index => $status)
                @if ($status)
        "{{$status->id}}": {
            from: {{ $index == 0 ? 0 : ($previousTo + 16) }},
            to: {{ $index == 0 ? 342 : ($previousTo + 16 + 342) }},
            name: "{{$status->name}}",
            id: "{{$status->id}}"
        } @if (!$loop->last),@endif
        @php $previousTo = $index == 0 ? 342 : ($previousTo + 16 + 342); @endphp
        @endif
        @endforeach
    };


    let closedList = {{json_encode($closedList)}};
    closedList.forEach(statusId => {
        changeKanbanBlocksBoundary(statusId, 'closed');
    })
    ...
    $(document).ready(function () {
        $(document).on('click', '.visibility-change', function () {
            ...
            if ($(this).data('visibility') === 1) {
                $('.view-lead-popup').addClass('zi10000')
                createConfirmV3('@lang('message.set_hidden')', '@lang('message.do_you_want_to_make_this_lead_invisible')', function () {
        ...
        if ($('#full_data').prop('checked')) {
            $('.lead-opener.closed').each(function () {
                $(this).trigger('click');
            })
        } else {
            /*$('.lead-opener:not(.closed)').each(function(){
                $(this).trigger('click');
            })*/
        }

        /*$('.kanban-avaliable').sortable({revert: true});*/
        $(".lead-item").draggable({
            connectToSortable: ".kanban-avaliable",
            revert: false,
            cursorAt: {
                left: 150,
                top: 10
            ...
            drag: function (event, ui) {
                let leftPos = $(this).css('left').split('px')[0];
                let blockNumber_ = null;
                for (const [key, value] of Object.entries(blockPositions)) {
                    if ((+leftPos + 171) > value.from && (+leftPos + 171) < value.to) {
                        blockNumber_ = key;
                        break;
                    }
                }
                if (blockNumber_) {
                    $('.kanban-item').removeClass('colored');
                    $('#kanban_col-' + blockNumber_).addClass('colored');
                } else {
                    $('.kanban-item').removeClass('colored');
                }
            },
            start: function (event, ui) {
                $('.kanban-sortable').removeClass('kanban-avaliable').removeClass('colored');
                $('.kanban-item').addClass('opacity-05');
                $(this).data('avaliable_statuses').forEach((element) => {
                    $('#kanban_col-' + element).removeClass('opacity-05');
                    $('#status-block-' + element).addClass('kanban-avaliable');
                })
                $(this).closest('.kanban-item').removeClass('opacity-05');
            },
            stop: function () {
                let this_ = this;

                let left = $(this).css('left').split('px')[0];
                let blockNumber = $(this).closest('.kanban-sortable').data('status_id');
                let class_id = $(this_).data('class_id');
                let selections = $(this).data('selections');

                let found = false;
                $('.notify-close').trigger('click');
                for (const [key, value] of Object.entries(blockPositions)) {
                    if ((+left + 171) > value.from && (+left + 171) < value.to) {
                        blockNumber = value.id;
                        found = true;
                        break;
                    }
                }
                if ([4].includes(+blockNumber) && (!selections || selections.length === 0)) { // Нельзя отправить в подборка отправлена если лид не имеет подборок
                    notify(`@lang('message.this_lead_has_no_collections')`);

                    $(this).css('left', '').css('top', '').css('position', '');
                    $('.kanban-item').removeClass('opacity-05').removeClass('colored');
                    return;
                }

                if (found) {
                    if ($(this).data('avaliable_statuses').includes(+blockNumber)) {
                        if ((blockNumber == 2 && $(this).data('status_id') == 1) || (blockNumber == 4 && $(this).data('status_id') == 3)) {
                            $.post(
                                '/manager/leads/change-status',
                                {
                                    'id': $(this).attr('id').split('-')[1],
                                    'status_id': blockNumber
                                },
                                function (response) {
                                    if (response.success) {
                                        let statusArray = [];
                                        for (const [key, value] of Object.entries(response.statuses)) {
                                            statusArray.push(+key);
                                        }
                                        $(this_).data('avaliable_statuses', statusArray);
                                        $(this_).data('status_id', blockNumber);
                                        $('#status-block-' + blockNumber).prepend(this_);
                                        checkLeadsCountKanban();
                                        notify(response.message);
                                        $(this_).css('left', '').css('top', '').css('position', '');
                                    } else {
                                        notify(response.message);
                                        $(this_).css('left', '').css('top', '').css('position', '');
                                    }
                                    $('.kanban-item').removeClass('opacity-05');
                                    $('.kanban-item').removeClass('colored');
                                }
                            )
                        } else {
                            ...
                            if ([2,3,4,5,8,9,10].includes(+blockNumber)) {
                                if ([3].includes(+blockNumber) && !$(this).data('class_id')) {
                                    view = qualificationPassedForm.split('##ID##').join($(this).attr('id').split('-')[1]).split('##OLD_STATUS##').join($(this).data('status_id')).split('##NEW_STATUS##').join(blockNumber).split('##NAME##').join(blockPositions[+blockNumber].name);
                                } else {
                                    view = defaultStatusForm
                                        .split('##ID##').join($(this).attr('id').split('-')[1])
                                        .split('##OLD_STATUS##').join($(this).data('status_id'))
                                        .split('##NEW_STATUS##').join(blockNumber)
                                        .split('##NAME##').join(blockPositions[+blockNumber].name)
                                        .split('##CLASS_ID##').join(class_id);
                                }
                            } else if (+blockNumber === 6) {
                                view = pauseStatusForm.split('##ID##').join($(this).attr('id').split('-')[1]).split('##OLD_STATUS##').join($(this).data('status_id')).split('##NEW_STATUS##').join(blockNumber).split('##NAME##').join(blockPositions[+blockNumber].name);
                            } else if (+blockNumber === 7) {
                                view = invalidStatusForm.split('##ID##').join($(this).attr('id').split('-')[1]).split('##OLD_STATUS##').join($(this).data('status_id')).split('##NEW_STATUS##').join(blockNumber).split('##NAME##').join(blockPositions[+blockNumber].name);
                            } else if (+blockNumber === 11) {
                                view = rejectStatusForm.split('##ID##').join($(this).attr('id').split('-')[1]).split('##OLD_STATUS##').join($(this).data('status_id')).split('##NEW_STATUS##').join(blockNumber).split('##NAME##').join(blockPositions[+blockNumber].name);
                            }
                            $('body').append(view);
                            $('#lead_status_id').select2({minimumResultsForSearch: -1});
                            $('#rejection_id').select2({minimumResultsForSearch: -1});
                            $('#class_id').select2({minimumResultsForSearch: -1});
                            ...
                            $('.datetime-input').datetimepicker({
                                ...
                                allowTimes: [
                                    ...
                                    '17:00', '17:15', '17:30', '17:45', '17:00', '18:15', '18:30', '18:45', '19:00', '19:15', '19:30', '19:45', '20:00', '20:15', '20:30', '20:45',
                                ]
                            });
                            $('.kanban-item').removeClass('op' +
                                'acity-05').removeClass('colored');
                        }
                    } else {
                        notify(`@lang('message.move_to') <b>"${blockPositions[blockNumber].name}"</b><br>@lang('message.not_available_from') <b>"${blockPositions[$(this).closest('.kanban-sortable').data('status_id')].name}"</b>`);
                        $(this).css('left', '').css('top', '').css('position', '');
                        // $('.kanban-item').removeClass('opacity-05').removeClass('colored');
                    }
                } else {
    ...
    const slider = document.querySelector('.kanban');
    ...
    const move = (e) => {
        //console.log(e);
        if (e.target.className === 'kanban-body') {
            e.preventDefault();
            if (!mouseDown) {
                return;
            }
