            ...
            <div class="field-container call-me-block">
                <div class="info-block">
                    <label class="radio-label">
                        <input type="checkbox" name="call_me">
                        @lang('message.remind_me_to_contact_the_lead')
                    </label>
                </div><br>
                <div class="input-block  dt" style="display:none;" >
                    <label>@lang('message.select_date_and_time')</label>
                    <input type="text" name="call_me_datetime" class="datetime-input" placeholder="@lang('message.date_time')" style="width:540px;" value=""/>
                </div>
            </div>
