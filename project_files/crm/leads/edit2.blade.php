            ...
            <form method="POST">
              ...
              <div class="field-container">
                ...
                <div class="input-block">
                  ...
                  <input type="text" name="fio" value="{{ $lead->fio }}" required/>
                  @if($errors['fio'])
              ...
              <div class="field-container">
                ...
                <div class="input-block">
                  <label>E-mail</label>
                  <input type="text" name="email2" value="{{ $lead->email }}"/>
                  @if($errors['email2'])
                ...
                <div class="input-block mr0">
                  <label>@lang('message.phone')</label>
                  <input type="text" name="phone2" value="{{ $lead->phone }}"/>
                  @if($errors['phone2'])
