                    ...
                    <form method="POST">
                            ...
                            <div class="input-block">
                                ...
                                <select name="month" class="marketing-month" required>
                                    @foreach($monthList as $ym => $name)
                                        <option value="{{$ym}}" @if($marketingData->month == $ym) selected @endif>{{$name}}</option>
                                    @endforeach
                                </select>
                                {{--
                                <input type="text" name="month" value="{{ $marketingData->month }}" required/>
                                --}}
                            </div>
                        </div>
                        <div class="hr"></div>
                        <div class="field-container">
                            <div class="input-block">
                                ...
                                <input type="text" name="seo_cost" value="{{ $marketingData->seo_cost }}" />
                            </div>
                            <div class="input-block">
                                <label>@lang('message.seo_click')</label>
                                <input type="text" name="seo_click" value="{{ $marketingData->seo_click }}" />
                            </div>
                        </div>
                        <div class="hr"></div>
                        <div class="field-container">
                            <div class="input-block">
                                ...
                                <input type="text" name="other_cost" value="{{ $marketingData->other_cost }}" />
                            </div>
                            {{--
                            <div class="input-block">
                                <label>@lang('message.other_click')</label>
                                <input type="text" name="other_click" value="{{ $marketingData->other_click }}" />
                            </div>
                            --}}
                        </div>
                        <div class="hr"></div>
