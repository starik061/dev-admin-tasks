    ...
    <div class="container-fluid container-fluid-base">
        <div class="row no-gutters">
            <div class="container container-base container-search-result manager-search our-details posts-block">
                ...
                <a class="crm-button abs-top-right" href="/manager/marketing-data/create">@lang('message.add')</a>
                <div class="content-block posts-block">
                    @if(!count($marketingData))
                            ...
                            <div class="clients-contracts-data">
                                <div class="data-table">
                                    <div class="data-thead">
                                        <div class="data-tr">
                                            <div class="data-td td-name">@lang('message.month')</div>
                                            <div class="data-td action-col"></div>
                                        </div>
                                    </div>
                                    <div class="data-tbody contracts-rows">
                                        @foreach($marketingData as $key => $item)
                                            <div class="data-tr" data-id="{{$item->id}}">
                                                <div class="data-td td-name"><span style="background: {{$item->background}}; color: {{$item->color}}">&bull; {{$monthList[$item->month]}}</span></div>
                                                <div class="data-td action-col">
                                                    <a href="/manager/marketing-data/{{$item->id}}/edit" class="edit">
...
<script>
    var main_url = '/manager/marketing-data';
</script>
