  ...
  <div class="container-fluid container-fluid-base">
    <div class="row no-gutters">
      <div class="container container-base container-search-result manager-search our-details posts-block">
        ...
        <a class="crm-button abs-top-right" href="/manager/posts/new">@lang('message.add_post')</a>
              ...
              <div class="data-table">
                ...
                @foreach($posts as $key => $item)
                  <div class="data-tr" data-id="{{$item->id}}">
                    <div class="data-td td-name"><span style="background: {{$item->background}}; color: {{$item->color}}">&bull; {{$item->name}}</span></div>
                    <div class="data-td action-col">
                      <a href="/manager/posts/{{$item->id}}/edit" class="edit @if(!$item->can_delete) mr0 @endif">
                    ...
                    @if($item->can_delete) 
                      <a class="post-delete pointer del_" data-id="{{$item->id}}">
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
